...
status_t GonkRecorder::setupSurfaceMediaSource() {
    status_t err = OK;
...
#endif
    //TODO: Currently just enable by default. Will need to check 7x27a later
    encoder_flags |= OMXCodec::kOnlySubmitOneInputBufferAtOneTime;
    //TODO: for debug purposes..
    //encoder_flags |= OMXCodec::kSoftwareCodecsOnly;
...
void GonkRecorder::setupMPEG4MetaData(int64_t startTimeUs, int32_t totalBitRate,
        sp<MetaData> *meta) {
    LOGV("*** In setup Starting time: %lld\n",startTimeUs);
...
status_t GonkRecorder::startMPEG4Recording() {
    ...
    //TODO: systemTime() doesn't give correct time because
...
//    mCameraSourceTimeLapse = NULL;
    ...
    //if someone is interested in recorder events
    mListener = NULL;
...
status_t GonkRecorder::startExtendedRecording() {
