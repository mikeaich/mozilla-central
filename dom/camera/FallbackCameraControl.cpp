...
NS_IMETHODIMP
nsCameraControl::GetMeteringAreas(JS::Value *aMeteringAreas)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP
nsCameraControl::SetMeteringAreas(const JS::Value & aMeteringAreas)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}
...
NS_IMETHODIMP
nsCameraControl::GetFocusAreas(JS::Value *aFocusAreas)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP
nsCameraControl::SetFocusAreas(const JS::Value & aFocusAreas)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}
...
NS_IMETHODIMP
nsCameraControl::StartRecording(const JS::Value & aOptions, nsICameraStartRecordingCallback *onSuccess, nsICameraErrorCallback *onError)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}
